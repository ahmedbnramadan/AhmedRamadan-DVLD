...
namespace DVLD
{
    public class frmEditApplicationType : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (_appType == null)
            {
                clsUtil.ShowError("Type not found.");
        ...
        private void _Save(object sender, EventArgs e)
        {
            ...
            // _appType was already loaded in OnLoad; no need to re-fetch it
            // here (the old code re-fetched it with no null check, which
            // would throw a NullReferenceException if the record had been
